...
const process = [
  {
    ...
    title: "Bedömning",
    desc: "Vi går igenom bostaden, omfattningen och riskerna innan arbetet planeras.",
  },
  {
    icon: <Trash2 className="w-6 h-6 text-cyan-accent" />,
    title: "Rensning",
    desc: "Avfall, skadat material och uppsamling hanteras metodiskt och diskret.",
  },
  {
...
export default function Socialsanering() {
  return (
    ...
    >
      ...
      <motion.section
        className="bg-midnight text-white p-6 sm:p-10 md:p-16 rounded-[1.75rem] md:rounded-[3rem] mb-10 sm:mb-16 md:mb-20"
        {...fadeInUp}
      >
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full bg-white/10 text-cyan-accent font-bold text-xs sm:text-sm mb-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-7 sm:mt-9">
            <a
              href="tel:0101234567"
              className="inline-flex items-center justify-center gap-3 rounded-full bg-cyan-accent text-white px-6 py-4 text-sm sm:text-base font-bold hover:bg-cyan-accent/90 transition-colors"
            >
            ...
            <a
              href="#process"
              className="inline-flex items-center justify-center rounded-full border border-white/20 text-white px-6 py-4 text-sm sm:text-base font-bold hover:border-white/40 transition-colors"
            >
              Så arbetar vi
            </a>
          </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8 md:gap-10 mb-10 sm:mb-16 md:mb-20">
        <motion.div
          className="bg-slate-50 p-6 sm:p-8 md:p-10 rounded-[1.75rem] md:rounded-[2rem] border border-midnight/5"
          {...fadeInUp}
        >
        ...
        <motion.div
          className="bg-white p-6 sm:p-8 md:p-10 rounded-[1.75rem] md:rounded-[2rem] border border-slate-200"
          {...fadeInUp}
      ...
      <section id="process" className="mb-10 sm:mb-16 md:mb-20">
        <motion.div className="text-center mb-7 sm:mb-10 md:mb-12" {...fadeInUp}>
      ...
      <motion.section
        className="bg-midnight text-white p-6 sm:p-10 md:p-16 rounded-[1.75rem] md:rounded-[3rem] text-center"
        {...fadeInUp}
      >
        ...
        <p className="text-base sm:text-lg md:text-xl font-light opacity-80 mb-7 sm:mb-10 max-w-3xl mx-auto leading-relaxed">
          Kontakta oss för en första bedömning. Vi hjälper dig att förstå vad
          som behöver göras och hur arbetet kan genomföras tryggt och diskret.
        </p>
